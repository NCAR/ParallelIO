 ...
 *
 * This program designates two processors as compute and two as I/O.
 */
...
int main(int argc, char* argv[])
{
    ...
    if ((ret = PIOc_Init_Intercomm(ntasks, MPI_COMM_WORLD, MPI_COMM_WORLD, MPI_COMM_WORLD, &iosysid)))
	ERR(ret);
