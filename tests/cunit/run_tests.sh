...
# test_darray_multivar3 test_pioc_fill  test_async_1d 
...
'test_pioc_unlim test_pioc_putget test_darray test_darray_multi '\
...
'test_darray_fill test_darray_vard test_darray_append'
...
#test_async_multi2  
PIO_TESTS_8='test_async_manyproc'
