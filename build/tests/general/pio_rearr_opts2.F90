...
! from /home/tkurc/codar/e3sm/pio_adios1/ParallelIO/tests/general/pio_rearr_opts2.F90.in

MODULE pio_rearr_opts2_tgv   ! pio_rearr_opts2.F90.in:1
...
END MODULE pio_rearr_opts2_tgv   ! pio_rearr_opts2.F90.in:6
...
SUBROUTINE open_file_and_get_var(pio_file, iotype, pio_var, ret)   ! pio_rearr_opts2.F90.in:201
  ...
  use pio_rearr_opts2_tgv   ! pio_rearr_opts2.F90.in:203
...
SUBROUTINE set_rearr_opts_and_write
  ...
  use pio_rearr_opts2_tgv   ! pio_rearr_opts2.F90.in:225
              ...
              do cur_enable_hs_i2c=1,num_enable_hs_opts_io2comp   ! pio_rearr_opts2.F90.in:349
                ...
                do cur_enable_isend_i2c=1,num_enable_isend_opts_io2comp   ! pio_rearr_opts2.F90.in:353
                  ...
                  do cur_max_pend_req_i2c=1,num_max_pend_req_opts_io2comp   ! pio_rearr_opts2.F90.in:357
                    ...
                    call PIO_closefile(pio_file)   ! pio_rearr_opts2.F90.in:389


                    call open_file_and_get_var(pio_file, iotypes(i), pio_var, ret)   ! pio_rearr_opts2.F90.in:391
                    
                    IF (.NOT. (PIO_TF_Passert_((ret) == PIO_NOERR, pio_tf_comm_))) THEN
                      pio_tf_retval_utest_ = -1
                      IF (pio_tf_world_rank_ == 0) THEN
                        PRINT *, "PIO_TF: PIO Function failed:",&
                           "Reopening file/decomp/var reqd for test failed :" // trim(tgv_fname),&
                          ":", __FILE__, ":", __LINE__,&
                          "(pio_rearr_opts2.F90.in:392)"
                      END IF
                      RETURN
                    END IF   ! pio_rearr_opts2.F90.in:392
#else
                    call PIO_syncfile(pio_file)   ! pio_rearr_opts2.F90.in:394
#endif


                    call PIO_read_darray(pio_file, pio_var, iodesc, rbuf, ret)   ! pio_rearr_opts2.F90.in:397
                    ...
                    IF (.NOT. PIO_TF_Check_val_(rbuf, wbuf)) THEN
                      ...
                      IF (pio_tf_world_rank_ == 0) THEN
                        PRINT *, "PIO_TF: PIO Check failed:",&
                           "Got wrong val",&
                          ":", __FILE__, ":", __LINE__,&
                          "(pio_rearr_opts2.F90.in:400)"
                      END IF
                      RETURN
                    END IF   ! pio_rearr_opts2.F90.in:400


                    call PIO_freedecomp(pio_tf_iosystem_, iodesc)   ! pio_rearr_opts2.F90.in:402


                    deallocate(rbuf)   ! pio_rearr_opts2.F90.in:404
                    if(allocated(wbuf)) then   ! pio_rearr_opts2.F90.in:405
                      deallocate(wbuf)   ! pio_rearr_opts2.F90.in:406
                    end if   ! pio_rearr_opts2.F90.in:407


                  end do ! cur_max_pend_req_i2c   ! pio_rearr_opts2.F90.in:409
                end do ! cur_enable_isend_i2c   ! pio_rearr_opts2.F90.in:410
              end do ! cur_enable_hs_i2c   ! pio_rearr_opts2.F90.in:411
            end do ! cur_max_pend_req_c2i       ! pio_rearr_opts2.F90.in:412
          end do ! cur_enable_isend_c2i   ! pio_rearr_opts2.F90.in:413
        end do ! cur_enable_hs_c2i   ! pio_rearr_opts2.F90.in:414
      end do ! cur_fcd_opt   ! pio_rearr_opts2.F90.in:415
    end do ! cur_comm_type_opt   ! pio_rearr_opts2.F90.in:416


    call PIO_closefile(pio_file)   ! pio_rearr_opts2.F90.in:418
    call PIO_deletefile(pio_tf_iosystem_, trim(tgv_fname))   ! pio_rearr_opts2.F90.in:419
  end do ! iotypes   ! pio_rearr_opts2.F90.in:420


  if(allocated(iotypes)) then   ! pio_rearr_opts2.F90.in:422
    deallocate(iotypes)   ! pio_rearr_opts2.F90.in:423
    deallocate(iotype_descs)   ! pio_rearr_opts2.F90.in:424
  end if   ! pio_rearr_opts2.F90.in:425


END SUBROUTINE set_rearr_opts_and_write   ! pio_rearr_opts2.F90.in:427
