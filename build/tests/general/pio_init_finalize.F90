...
! from /home/tkurc/codar/e3sm/pio_adios1/ParallelIO/tests/general/pio_init_finalize.F90.in

SUBROUTINE init_finalize
  USE pio_tutil
   ! pio_init_finalize.F90.in:1
  ! The default test driver should initialize and finalize PIO
  PRINT *, "Hello world"   ! pio_init_finalize.F90.in:3
END SUBROUTINE init_finalize   ! pio_init_finalize.F90.in:4
  ...
  SUBROUTINE PIO_TF_Test_driver_
    ...
    IF (pio_tf_world_rank_ == 0) THEN
      PRINT *, "PIO_TF: Starting init_finalize"
    END IF
    CALL init_finalize()
    ...
    IF (pio_tf_world_rank_ == 0) THEN
      IF (pio_tf_retval_utest_ == 0) THEN
        WRITE(*,PIO_TF_TEST_RES_FMT) "PIO_TF:Test 1:",&
          "init_finalize","-----------", "PASSED"
      ELSE
        WRITE(*,PIO_TF_TEST_RES_FMT) "PIO_TF:Test 1:",&
          "init_finalize","-----------", "FAILED"
      END IF
    END IF
